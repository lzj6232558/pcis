...
<head>
    ...
    <script type="text/javascript" src="/static/js/policy/checkPending.js"></script>
</head>
<body>
...
<div id="temporary_toolbar">
    ...
    <form id="temporary_form" method="post">
        ...
        <a id="btn_putUp" class="easyui-linkbutton" iconCls="icon-back" plain="true" data-cmd="back">退回</a>
        <a id="btn_edit" class="easyui-linkbutton" iconCls="icon-pass" plain="true" data-cmd="pass">通过</a>
